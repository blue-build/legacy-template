...
## This isn't intended to be used by anyone else. this is a specific version for my needs and hardware so at your risks
**[If you want to build one for your needs just check ublue website](https://ublue.it/making-your-own/)**

**rebase :** `sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/mimillieuh/mimillieuhubluenvidia:latest`

### Current custom changes to base
- add mesa-libGLU for Davinci Resolve
- add kernel-tools for cpupower batterylife improvements.
- add langpacks-fr for some apps in french
- add python3-pip for pip packages
- add gnome-themes-extra and gtk-murrine-engine for vinceliuice themes
- add neofetch to flex ;-;
